...
class AddFragment : Fragment() {
    ...
    private fun addNote() {
        ...
        if(noteText.isEmpty()) {
            Toast.makeText(view?.context, getString(R.string.emptyNote), Toast.LENGTH_LONG).show()
        }
        else {
            ...
            Toast.makeText(requireContext(), getString(R.string.saveSuccess), Toast.LENGTH_LONG).show()
            findNavController().navigate(R.id.action_addFragment_to_listFragment)
        }
    }
}